...
import 'package:meow/screen/product_category/view/product_category_manage.dart';
import 'package:meow/screen/promotion/view/promotion_manage.dart';
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        trailing: Text("${promotion.promotionValue}ks",
                            style: TextStyle(
                              color: Colors.black,
                              fontSize: 18,
                            )),
