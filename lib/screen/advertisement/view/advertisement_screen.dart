...
import 'package:meow/screen/advertisement/controller/advertisement_controller.dart';
                ...
                () {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      var advertisement =
                          _homeController.advertisementList[index];

                      return InkWell(
                        onTap: () =>
                            Get.to(ManageAdvertisementScreen(advertisement)),
